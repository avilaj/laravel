...
var ProductController = function () {
  ...
  _createClass(ProductController, [{
    key: 'productAdded',
    value: function productAdded(reference) {
      return _lodash2.default.includes(this.bought, this.reference.id);
    }
  }, {
    key: 'buy',
    value: function buy() {
      ...
      var reference_id = this.reference.id;
      return this.cart.update(reference_id, this.size.size_id, this.qty).then(function (r) {
        return _this2.bought.push(reference_id);
      });
    }
  }, {
